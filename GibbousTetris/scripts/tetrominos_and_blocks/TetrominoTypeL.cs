...
{
    public class TetrominoTypeL : Tetromino
    {
        public TetrominoTypeL(int xIndex, int yIndex) : base(xIndex, yIndex, Color.Purple, Angle.Right)
        {
        }
        ...
        public override void Rotate()
        {
            switch (this.TetrominoAngle)
            {
                case Angle.Left:
                {
                    ...
                    {
                        if ((BlocksController.Instance.BlocksIndex[YIndex - 1, XIndex] == 0) && (BlocksController.Instance.BlocksIndex[YIndex + 1, XIndex] == 0) && (BlocksController.Instance.BlocksIndex[YIndex + 1, XIndex + 1] == 0))
                        {    
                ...
                case Angle.Up:
                {
                    if (this.XIndex > 0)
                    {
                        if ((BlocksController.Instance.BlocksIndex[YIndex, XIndex + 1] == 0) && (BlocksController.Instance.BlocksIndex[YIndex, XIndex - 1] == 0) && (BlocksController.Instance.BlocksIndex[YIndex + 1, XIndex - 1] == 0))
                        { 

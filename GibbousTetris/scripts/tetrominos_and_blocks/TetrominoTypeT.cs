...
{
    public class TetrominoTypeT : Tetromino
    {
        public TetrominoTypeT(int xIndex, int yIndex) : base(xIndex, yIndex, Color.Yellow, Angle.Up)
        {
        }
        ...
        public override void Rotate()
        {
            switch (this.TetrominoAngle)
            {
                case Angle.Left:
                {
                    if ((this.XIndex > 0))
                    {
                        if (BlocksController.Instance.BlocksIndex[YIndex, XIndex - 1] == 0)
                        {    
                ...
                case Angle.Up:
                {
                    if (this.YIndex > 0)
                    {
                        if (BlocksController.Instance.BlocksIndex[YIndex - 1, XIndex] == 0)
                        { 
